...
if (!token) {
    ...
    function parseBrisbaneDateTime(dateTimeText) {
        const match =
            dateTimeText
                .trim()
                .toUpperCase()
        ...
        async interaction => {
                ...
                if (
                    ...
                    const startDateTimeInput =
                        new TextInputBuilder()
                            ...
                            .setLabel(
                                "Start Date & Time - Brisbane"
                            )
                            .setPlaceholder(
                                "Example: 12/08/2026 11:00 AM"
                            )
                            .setStyle(
                                TextInputStyle.Short
                            )
                    ...
                    const roomCodeInput =
                        new TextInputBuilder()
                            ...
                            .setLabel(
                                "Private RuneLite Room Code"
                            )
                            .setPlaceholder(
                                "Only accepted racers will receive this"
                            )
                            .setStyle(
                                TextInputStyle.Short
                            )
            ...
            if (
                ...
                if (!roomCode) {
                    await interaction.reply({
                        content:
                            "❌ You need to enter the private RuneLite room code.",
                        flags:
                        MessageFlags.Ephemeral
                    });
                ...
                try {
                    ...
                    const race = {
                        ...
                        /*
                         * PRIVATE.
                         * Never put this in the public race embed.
                         */
                        roomCode,
                    ...
                    await interaction.reply({
                        content:
                            ...
                            `🔒 Room code **${roomCode}** is private and will only be sent to racers you accept.`,
                        flags:
                        MessageFlags.Ephemeral
                    });
            ...
            if (
                ...
                try {
                    ...
                    await applicant.send(
                        ...
                        `**Start:** <t:${race.unixTimestamp}:F>\n` +
                        `**Starts:** <t:${race.unixTimestamp}:R>\n\n` +
                        `🔑 **RuneLite Room Code:** \`${race.roomCode}\`\n\n` +
                        `Open the 0GP Race plugin in RuneLite and join using this room code.`
                    );
